...
{
    public class SlabTile : Tile
    {
        public SlabTile(int id, int tex) : base(id, tex)
        {
        ...
        public override void renderFace(Tesselator t, int x, int y, int z, int face)
        {
            ...
            {
                t.vertexUV(x1, y + 0.5f, z1, u1, v1);
                t.vertexUV(x1, y + 0.5f, z0, u1, v0);
                t.vertexUV(x0, y + 0.5f, z0, u0, v0);
                t.vertexUV(x0, y + 0.5f, z1, u0, v1);
            }
            else if (face == 2)
            {
            ...
            {
                t.vertexUV(x0, y + 0.5f, z1, u1, v1);
                t.vertexUV(x0, y0, z1, u0, v1);
                t.vertexUV(x1, y0, z1, u0, v0);
                t.vertexUV(x1, y + 0.5f, z1, u1, v0);
            }
            else if (face == 4)
            {
                t.vertexUV(x0, y + 0.5f, z1, u0, v1);
