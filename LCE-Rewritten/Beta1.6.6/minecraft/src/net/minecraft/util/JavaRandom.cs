...
namespace net.minecraft.util
{
    ...
    /** use serialVersionUID from JDK 1.1 for interoperability */
        static readonly long serialVersionUID = 3905348978240129619L;
        ...
        */
        public JavaRandom() :this(seedUniquifier() ^ DateTime.Now.Ticks)
        {
        ...
        private static long seedUniquifier()
        {
            ...
            for (;;)
            {
                long current = SeedUniquifierField.Value;
                long next = current * 181783497276652981L;
                if (SeedUniquifierField.CompareAndSet(current, next))
                    return next;
            }
        }

        private static readonly AtomicLong SeedUniquifierField
