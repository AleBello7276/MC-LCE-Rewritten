...
namespace net.minecraft.src.world.chunk
{
	public class ChunkCache : IBlockAccess {
		...
		public ChunkCache(World var1, int var2, int var3, int var4, int var5, int var6, int var7) {
			...
			int var8 = var5 >> 4;
			int var9 = var7 >> 4;
			this.chunkArray = new Chunk[var8 - this.chunkX + 1][]; //first part of the array

			for(int var10 = this.chunkX; var10 <= var8; ++var10) 
			{
				this.chunkArray[var10 - this.chunkX] = new Chunk[var9 - this.chunkZ + 1]; //second part of the array
		...
		public bool func_28100_h(int var1, int var2, int var3) {
			Block var4 = Block.blocksList[this.getBlockId(var1, var2, var3)];
