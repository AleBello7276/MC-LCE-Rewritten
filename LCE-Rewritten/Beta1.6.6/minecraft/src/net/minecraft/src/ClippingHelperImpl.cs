...
namespace net.minecraft.src
{
	public class ClippingHelperImpl : ClippingHelper {
		...
		private float[] field_1691_h = new float[16];
		...
		private void init() {
            ...
            Array.Clear(projectionMatrixBuffer);
            Array.Clear(modelviewMatrixBuffer);
            Array.Clear(field_1691_h);
            GL.GetFloat(GetPName.ProjectionMatrix, this.projectionMatrixBuffer);
			GL.GetFloat(GetPName.ModelviewMatrix, this.modelviewMatrixBuffer);
            Array.Copy(projectionMatrixBuffer, projectionMatrix, 16);
            Array.Copy(modelviewMatrixBuffer, modelviewMatrix, 16);
