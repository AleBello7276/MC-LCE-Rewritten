...
{
	internal class J_ChainedFunctor : J_Functor {
		private readonly J_JsonNodeSelector field_27062_a;
		private readonly J_JsonNodeSelector field_27061_b;

		public J_ChainedFunctor(J_JsonNodeSelector var1, J_JsonNodeSelector var2) {
			this.field_27062_a = var1;
			this.field_27061_b = var2;
		}

		public bool func_27058_a(Object var1) {
